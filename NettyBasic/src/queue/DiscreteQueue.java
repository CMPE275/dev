...
public class DiscreteQueue implements ChannelQueue {
	...
	public static LinkedBlockingDeque<OneQueueEntry> getInbound() {
		return inbound;
	}

	public static void setInbound(LinkedBlockingDeque<OneQueueEntry> inbound) {
		DiscreteQueue.inbound = inbound;
	}

	public static LinkedBlockingDeque<OneQueueEntry> getOutbound() {
		return outbound;
	}

	public static void setOutbound(LinkedBlockingDeque<OneQueueEntry> outbound) {
		DiscreteQueue.outbound = outbound;
	}
